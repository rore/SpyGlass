...
/**
* The HBaseMultiTableRawScheme class is a {@link Scheme} subclass. It is used in conjunction
* with the {@HBaseMultiTableRawTap} to allow for the reading and writing of data
* to and from multiple tables in an HBase cluster.
*
* @see HBaseRawTap
*/
@SuppressWarnings({ "rawtypes", "deprecation" })
public class HBaseMultiTableRawScheme extends Scheme<JobConf, RecordReader, OutputCollector, Object[], Object[]> {
	/**
	 *
	 */
	...
	/** Field LOG */
	private static final Logger LOG = LoggerFactory.getLogger(HBaseMultiTableRawScheme.class);

	public final Fields TableNameField = new Fields("tablename");
	 ...
	 *            of type Fields
	 */
	public HBaseMultiTableRawScheme(String familyName) {
		this(new String[] { familyName });
	}

	public HBaseMultiTableRawScheme(String[] familyNames) {
		this.familyNames = familyNames;
		setSourceFields();
	}

	public HBaseMultiTableRawScheme(String familyName, boolean writeNulls) {
		this(new String[] { familyName }, writeNulls);
	}

	public HBaseMultiTableRawScheme(String[] familyNames, boolean writeNulls) {
		this.familyNames = familyNames;
	...
	public void sinkConfInit(FlowProcess<JobConf> process, Tap<JobConf, RecordReader, OutputCollector> tap, JobConf conf) {
		DeprecatedOutputFormatWrapper.setOutputFormat(org.apache.hadoop.hbase.mapreduce.MultiTableOutputFormat.class, conf);
	...
	public void sourceConfInit(FlowProcess<JobConf> process, Tap<JobConf, RecordReader, OutputCollector> tap,
			JobConf conf) {
		DeprecatedInputFormatWrapper.setInputFormat(org.apache.hadoop.hbase.mapreduce.MultiTableInputFormat.class, conf,
				ValueCopier.class);
		if (null != familyNames) {
	...
	public boolean equals(Object object) {
		...
		HBaseMultiTableRawScheme that = (HBaseMultiTableRawScheme) object;
